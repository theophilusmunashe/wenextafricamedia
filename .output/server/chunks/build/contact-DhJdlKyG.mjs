...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "info-contact section-padding sub-bg pt-0" }, _attrs))}><div class="container"><div class="sec-head text-center mb-80"><span class="sub-title mb-15 opacity-8">- Contact Info</span><h3 class="text-u fz-50">Contact With Us!</h3></div><div class="row justify-content-center"><div class="col-lg-4 col-md-6"><div class="item text-center sm-mb50 md-mb50"><span class="sub-title opacity-8 mb-5">Email :</span><h6>info@sources.com</h6></div></div><div class="col-lg-4 col-md-6"><div class="item text-center sm-mb50"><span class="sub-title opacity-8 mb-5">office :</span><h6>2nd floor , Runhare House <br> Harare, Zimbabwe</h6></div></div><div class="col-lg-4 col-md-6"><div class="item text-center"><span class="sub-title opacity-8 mb-5">Phone :</span><h6>+2 456 34324 45</h6></div></div></div></div></section>`);
}
...
//# sourceMappingURL=contact-DhJdlKyG.mjs.map
