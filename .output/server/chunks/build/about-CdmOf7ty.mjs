import { _ as _sfc_main$6 } from './virtual_public-DtKfMkMj.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$7 } from './Menu-BFis53zK.mjs';
...
import { _ as _sfc_main$8 } from './Footer1-CY2Y8zy_.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "about-header section-padding pb-0" }, _attrs))}><div class="container mt-100"><div class="row"><div class="col-lg-9 offset-lg-1"><div class="cont"><h6 class="sub-title mb-15">WeNext Media</h6><h1 class="text-u">About Us</h1></div></div></div></div><div class="img mt-80" data-overlay-dark="4"><img${ssrRenderAttr("src", _imports_0)} alt=""></div></header>`);
}
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section-padding" }, _attrs))}><div class="container"><div class="row"><div class="col-lg-10"><div class="text"><span class="sub-title mb-15 opacity-8">- What We Believe?</span><div class="text-reval"><h2 class="fz-50 text-u mb-30"><span class="text">At WeNext Africa Media, </span><span class="text">we believe that every brand </span><span class="text">has a unique story to tell.</span></h2></div><p> WeNext Africa Media is a young and energetic creative agency. We combine imaginative thinking with strategic planning to craft a stand-out image for your brand.Our mission is to uncover that story and convey it in a way that resonates deeply with your target audience. We approach each project with a collaborative spirit, working closely with our clients to understand their vision, goals, and challenges. This partnership-driven approach allows us to develop tailored strategies that deliver tangible results. </p></div></div></div><div class="row"><div class="col-lg-10 offset-lg-1"><div class="row mt-80"><div class="col-md-4 sm-mb30"><ul class="list rest"><li class="fz-18 mb-15"><span class="mr-10">+</span> Advertising Campaigns</li><li class="fz-18 mb-15"><span class="mr-10">+</span> Content Creation</li></ul></div><div class="col-md-4 sm-mb30"><ul class="list rest"><li class="fz-18 mb-15"><span class="mr-10">+</span> Public Relations</li><li class="fz-18 mb-15"><span class="mr-10">+</span> Live Streaming</li></ul></div><div class="col-md-4"><ul class="list rest"><li class="fz-18 mb-15"><span class="mr-10">+</span> Videography</li><li class="fz-18 mb-15"><span class="mr-10">+</span> Digital Experiences</li></ul></div></div><div class="row numbers mt-80"><div class="col-lg-4"><div class="item md-mb50"><h3 class="stroke f-bold num pb-30 mb-30 bord-thin-bottom">58</h3><h6 class="fz-16">Projects Completed</h6></div></div><div class="col-lg-4"><div class="item md-mb50"><h3 class="stroke f-bold num pb-30 mb-30 bord-thin-bottom">34</h3><h6 class="fz-16">Clients Around the World</h6></div></div><div class="col-lg-4"><div class="item"><h3 class="stroke f-bold num pb-30 mb-30 bord-thin-bottom">3</h3><h6 class="fz-16">Total Awards</h6></div></div></div></div></div></div></section>`);
    };
  }
};
...
const data$1 = [
  ...
  },
  {
    ...
    image: "/assets/imgs/team/t2.jpeg"
  },
  {
    id: 3,
    title: "Nadia",
...
const data = [
  {
    id: 1,
    quote: "WeNext Africa Media brought a fresh and innovative approach to our marketing campaigns. Their strategic thinking and creative execution helped us connect with our audience in a meaningful way. The team\u2019s professionalism and dedication are truly commendable.",
    author: "",
    client: "Econet Wireless"
  },
  {
    id: 2,
    quote: "Working with WeNext Africa Media has been a game-changer for us. Their expertise in brand strategy and creative services has significantly enhanced our brand\u2019s visibility and engagement. We are extremely satisfied with the results and look forward to a long-term partnership.",
    author: "",
    client: ""
  },
  {
    id: 3,
    quote: "The creative team at WeNext Africa Media exceeded our expectations. Their ability to understand our needs and deliver compelling content has greatly improved our public relations efforts. Their innovative solutions have set a new standard for our communication strategies.",
    author: "",
    client: "CCTV"
  },
  {
    id: 4,
    quote: "WeNext Africa Media transformed our digital presence with their exceptional content creation and advertising campaigns. Their strategic insights and creative execution have made a significant impact on our audience reach and engagement. We highly recommend their services.",
    author: "",
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      titleTemplate: `WeNext Africa Media: About`,
      bodyAttrs: {
        class: "main-bg"
      },
      script: [
...
//# sourceMappingURL=about-CdmOf7ty.mjs.map
